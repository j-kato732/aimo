...
//promiseの時はasync
export async function getPolicy(period, access_token){
  return new Promise((resolve,reject)=>{
    axios
      .get(`${baseUrl}:${port}/policy?period=${period}`, {
        headers: {
...
export async function getDepartmentGoal(period, departmentId, access_token){
  return new Promise((resolve,reject)=>{
    axios
      .get(`${baseUrl}:${port}/departmentGoal?period=${period}&departmentId=${departmentId}`, {
        headers: {
          Authorization: `Bearer ${access_token}`,
        },
      })
...
export async function getRole(period, departmentId, jobId, access_token){
  return new Promise((resolve,reject)=>{
    axios
      .get(`${baseUrl}:${port}/role?period=${period}&departmentId=${departmentId}&jobId=${jobId}`, {
        headers: {
          Authorization: `Bearer ${access_token}`,
        },
      })
...
export async function getAims(period, userId, access_token){
  return new Promise((resolve,reject)=>{
    axios
      .get(`${baseUrl}:${port}/aims?period=${period}&userId=${userId}`, {
        headers: {
          Authorization: `Bearer ${access_token}`,
        },
      })
...
export async function getAchievementMean(period, userId, aim_number, achievement_mean_number, access_token){
  return new Promise((resolve,reject)=>{
    axios
      .get(`${baseUrl}:${port}/achievementMean?period=${period}&userId=${userId}&aimNumber=${aim_number}&achievementMeanNumber=${achievement_mean_number}`, {
        headers: {
          Authorization: `Bearer ${access_token}`,
        },
      })
