...
var file_proto_aimo_proto_rawDesc = []byte{
	...
	0x72, 0x73, 0x6f, 0x6e, 0x61, 0x6c, 0x45, 0x76, 0x61, 0x22, 0xa4, 0x01, 0x0a, 0x13, 0x50, 0x6f,
	...
	0x74, 0x65, 0x64, 0x41, 0x74, 0x3a, 0x06, 0xba, 0xb9, 0x19, 0x02, 0x08, 0x01, 0x22, 0xba, 0x01,
	...
	0x69, 0x64, 0x12, 0x2e, 0x0a, 0x12, 0x70, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x61, 0x6c, 0x45, 0x76,
	...
	0x74, 0x79, 0x3a, 0x06, 0xba, 0xb9, 0x19, 0x02, 0x08, 0x01, 0x32, 0x9f, 0x09, 0x0a, 0x04, 0x61,
	...
	0x72, 0x73, 0x6f, 0x6e, 0x61, 0x6c, 0x45, 0x76, 0x61, 0x3a, 0x01, 0x2a, 0x42, 0x21, 0x5a, 0x1f,
...
var file_proto_aimo_proto_msgTypes = make([]protoimpl.MessageInfo, 27)
var file_proto_aimo_proto_goTypes = []interface{}{
	...
	(*PostDefaultResponse)(nil),                                     // 14: aimo.PostDefaultResponse
	(*PutDefaultResponse)(nil),                                      // 15: aimo.PutDefaultResponse
	(*DefaultResponse)(nil),                                         // 16: aimo.DefaultResponse
	(*AimModel)(nil),                                                // 17: aimo.AimModel
	(*AchievementMeanModel)(nil),                                    // 18: aimo.AchievementMeanModel
	(*PersonalEvaModel)(nil),                                        // 19: aimo.PersonalEvaModel
	(*PostAimResponse_PostAimResult)(nil),                           // 20: aimo.PostAimResponse.PostAimResult
	(*GetAchievementMeansResponse_GetAchievementMeansResult)(nil),   // 21: aimo.GetAchievementMeansResponse.GetAchievementMeansResult
	(*PostAchievementMeanResponse_PostAchievementMeansResult)(nil),  // 22: aimo.PostAchievementMeanResponse.PostAchievementMeansResult
	(*PutAchievementMeansResponses_PutAchievementMeanResponse)(nil), // 23: aimo.PutAchievementMeansResponses.PutAchievementMeanResponse
	(*GetAchievementMeanResponse_GetAchievementMeanResult)(nil),     // 24: aimo.GetAchievementMeanResponse.GetAchievementMeanResult
	(*GetPersonalEvaResponse_GetPersonalEvaResult)(nil),             // 25: aimo.GetPersonalEvaResponse.GetPersonalEvaResult
	(*PostDefaultResponse_PostResult)(nil),                          // 26: aimo.PostDefaultResponse.PostResult
	(*timestamp.Timestamp)(nil),                                     // 27: google.protobuf.Timestamp
}
var file_proto_aimo_proto_depIdxs = []int32{
	16, // 0: aimo.GetAimResponse.response:type_name -> aimo.DefaultResponse
	2,  // 1: aimo.GetAimResponse.result:type_name -> aimo.GetAimResult
	17, // 2: aimo.GetAimResult.aim:type_name -> aimo.AimModel
	16, // 3: aimo.PostAimResponse.response:type_name -> aimo.DefaultResponse
	20, // 4: aimo.PostAimResponse.result:type_name -> aimo.PostAimResponse.PostAimResult
	16, // 5: aimo.PutAimResponse.response:type_name -> aimo.DefaultResponse
	16, // 6: aimo.GetAchievementMeansResponse.response:type_name -> aimo.DefaultResponse
	21, // 7: aimo.GetAchievementMeansResponse.result:type_name -> aimo.GetAchievementMeansResponse.GetAchievementMeansResult
	18, // 8: aimo.PostAchievementMeansRequest.achievement_means:type_name -> aimo.AchievementMeanModel
	16, // 9: aimo.PostAchievementMeanResponse.response:type_name -> aimo.DefaultResponse
	22, // 10: aimo.PostAchievementMeanResponse.result:type_name -> aimo.PostAchievementMeanResponse.PostAchievementMeansResult
	7,  // 11: aimo.PostAchievementMeansResponse.responses:type_name -> aimo.PostAchievementMeanResponse
	18, // 12: aimo.PutAchievementMeansRequest.achievement_means:type_name -> aimo.AchievementMeanModel
	23, // 13: aimo.PutAchievementMeansResponses.responses:type_name -> aimo.PutAchievementMeansResponses.PutAchievementMeanResponse
	16, // 14: aimo.GetAchievementMeanResponse.response:type_name -> aimo.DefaultResponse
	24, // 15: aimo.GetAchievementMeanResponse.result:type_name -> aimo.GetAchievementMeanResponse.GetAchievementMeanResult
	16, // 16: aimo.GetPersonalEvaResponse.response:type_name -> aimo.DefaultResponse
	25, // 17: aimo.GetPersonalEvaResponse.result:type_name -> aimo.GetPersonalEvaResponse.GetPersonalEvaResult
	16, // 18: aimo.PostDefaultResponse.response:type_name -> aimo.DefaultResponse
	26, // 19: aimo.PostDefaultResponse.result:type_name -> aimo.PostDefaultResponse.PostResult
	16, // 20: aimo.PutDefaultResponse.response:type_name -> aimo.DefaultResponse
	27, // 21: aimo.AimModel.created_at:type_name -> google.protobuf.Timestamp
	27, // 22: aimo.AimModel.updated_at:type_name -> google.protobuf.Timestamp
	27, // 23: aimo.AchievementMeanModel.created_at:type_name -> google.protobuf.Timestamp
	27, // 24: aimo.AchievementMeanModel.updated_at:type_name -> google.protobuf.Timestamp
	18, // 25: aimo.GetAchievementMeansResponse.GetAchievementMeansResult.achievement_means:type_name -> aimo.AchievementMeanModel
	16, // 26: aimo.PutAchievementMeansResponses.PutAchievementMeanResponse.response:type_name -> aimo.DefaultResponse
	18, // 27: aimo.GetAchievementMeanResponse.GetAchievementMeanResult.achievementMean:type_name -> aimo.AchievementMeanModel
	19, // 28: aimo.GetPersonalEvaResponse.GetPersonalEvaResult.personalEva:type_name -> aimo.PersonalEvaModel
	0,  // 29: aimo.aimo.getAim:input_type -> aimo.GetAimRequest
	17, // 30: aimo.aimo.postAim:input_type -> aimo.AimModel
	17, // 31: aimo.aimo.putAim:input_type -> aimo.AimModel
	18, // 32: aimo.aimo.getAchievementMeans:input_type -> aimo.AchievementMeanModel
	6,  // 33: aimo.aimo.postAchievementMeans:input_type -> aimo.PostAchievementMeansRequest
	9,  // 34: aimo.aimo.putAchievementMeans:input_type -> aimo.PutAchievementMeansRequest
	11, // 35: aimo.aimo.getAchievementMean:input_type -> aimo.GetAchievementMeanRequest
	18, // 36: aimo.aimo.postAchievementMean:input_type -> aimo.AchievementMeanModel
	18, // 37: aimo.aimo.putAchievementMean:input_type -> aimo.AchievementMeanModel
	19, // 38: aimo.aimo.getPersonalEva:input_type -> aimo.PersonalEvaModel
	19, // 39: aimo.aimo.postPersonalEva:input_type -> aimo.PersonalEvaModel
	19, // 40: aimo.aimo.putPersonalEva:input_type -> aimo.PersonalEvaModel
	1,  // 41: aimo.aimo.getAim:output_type -> aimo.GetAimResponse
	3,  // 42: aimo.aimo.postAim:output_type -> aimo.PostAimResponse
	4,  // 43: aimo.aimo.putAim:output_type -> aimo.PutAimResponse
	5,  // 44: aimo.aimo.getAchievementMeans:output_type -> aimo.GetAchievementMeansResponse
	8,  // 45: aimo.aimo.postAchievementMeans:output_type -> aimo.PostAchievementMeansResponse
	10, // 46: aimo.aimo.putAchievementMeans:output_type -> aimo.PutAchievementMeansResponses
	12, // 47: aimo.aimo.getAchievementMean:output_type -> aimo.GetAchievementMeanResponse
	7,  // 48: aimo.aimo.postAchievementMean:output_type -> aimo.PostAchievementMeanResponse
	15, // 49: aimo.aimo.putAchievementMean:output_type -> aimo.PutDefaultResponse
	13, // 50: aimo.aimo.getPersonalEva:output_type -> aimo.GetPersonalEvaResponse
	14, // 51: aimo.aimo.postPersonalEva:output_type -> aimo.PostDefaultResponse
	15, // 52: aimo.aimo.putPersonalEva:output_type -> aimo.PutDefaultResponse
